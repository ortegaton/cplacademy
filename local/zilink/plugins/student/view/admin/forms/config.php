...
class zilink_student_view_config_settings_form extends moodleform {
    ...
    public function definition() {
        ...
        $path = $CFG->dirroot.'/local/zilink/plugins/student/view/interfaces';
        $directories = array();
        $ignore = array( '.', '..','db','lang','error_log');
        $dh = @opendir( $path );
        ...
        $select = $mform->addElement('select', 'interface', get_string("student_view_interface", "local_zilink"), $directories);

...
class zilink_report_writer_config_settings_form extends moodleform {
    ...
    public function definition() {
        ...
        $path = $CFG->dirroot.'/local/zilink/plugins/report_writer/interfaces';
        $directories = array();
        ...
        $select = $mform->addElement('select', 'interface', get_string("report_writer_interface", "local_zilink"), $directories);

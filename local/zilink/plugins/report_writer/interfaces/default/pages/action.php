...
switch ($action)
{
    ...
    case "view_pupil_reports":
      
        $reportid = required_param('rid',PARAM_INTEGER);
        
        $report = $DB->get_record('zilink_report_writer_reports',array('id' => $reportid));
        
        if($report)
        {
            echo $report_writer->ViewPupils(array('cohortid' => $report->cohortid,'rid' => $reportid));
        }
        break;

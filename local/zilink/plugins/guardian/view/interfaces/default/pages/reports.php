...
$PAGE->https_required();
$PAGE->set_url('/local/zilink/plugins/guardian/view/pages/default/reports.php', $urlparams);
...
$PAGE->navbar->add(get_string('guardian_view_default_report', 'local_zilink'), new moodle_url('/local/zilink/plugins/guardian/view/pages/default/reports.php', $urlparams));
...
try {
    ...
    $args = array('action' => optional_param('action','list',PARAM_RAW),
                    'rid' => optional_param('rid','0',PARAM_RAW)
                  );
    $content = $portal->Reports($args);

...
$PAGE->navbar->add(get_string('guardian_view_default_student_details', 'local_zilink'), new moodle_url('/local/zilink/plugins/guardian/view/pages/default/index.php', $urlparams));

...
$PAGE->navbar->add(get_string('guardian_view_default_overview', 'local_zilink'), new moodle_url('/local/zilink/plugins/guardian/view/pages/default/overview.php', $urlparams));

...
$PAGE->https_required();
$PAGE->set_url('/local/zilink/plugins/guardian/view/pages/default/information.php', $urlparams);
$PAGE->verify_https_required();
$strmanage = get_string('guardian_view_default_information_page_title', 'local_zilink');
...
$PAGE->navbar->add(get_string('guardian_view_default_information', 'local_zilink'), new moodle_url('/local/zilink/plugins/guardian/view/pages/default/information.php', $urlparams));

...
class zilink_guardian_view_attendance_settings_form extends moodleform {
    ...
    public function definition() {
        ...
        $select = $mform->addElement('select', 'guardian_view_default_attendance_overview_delay', get_string('guardian_view_default_attendance_delay', 'local_zilink'), $list);
        $mform->addHelpButton('guardian_view_default_attendance_overview_delay', 'guardian_view_default_attendance_delay', 'local_zilink');

...
class zilink_guardian_account_manage_step_two_form extends moodleform {
    ...
    function definition() {
        ...
        $mform->addElement('html', '<th class="header c0" style="text-align:center;" scope="col">'.get_string('unlink', 'local_zilink').'</th>');
        $mform->addElement('html', '</tr></thead>');
        $mform->addElement('html', '<tbody>');
            ...
            foreach ($this->_customdata['students'] as $student)
            {
                ...
                foreach ($student->guardians as $guardian) {
                    ...
                    if($guardian->linked) 
                    {
                        ...
                        $mform->addElement('html', '<td class="cell c0" style="text-align:center; vertical-align: middle;">');
                        $mform->addElement('advcheckbox', 'unlink['.$student->idnumber.']['.$guardian->idnumber.']', null, '', array('group' => 1));
                        $mform->addElement('html', '</td>');

...
class zilink_guardian_account_create_step_three_form extends moodleform {
    ...
    function definition() {
        ...
        $mform->addElement('html', '<th class="header c0" style="text-align:center;" scope="col">'.get_string('linked', 'local_zilink').'</th>');

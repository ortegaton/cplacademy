...
class zilink_class_view_config_settings_form extends moodleform {
    ...
    public function definition() {
        ...
        $path = $CFG->dirroot.'/local/zilink/plugins/class/view/interfaces';
        $directories = array();
        ...
        $select = $mform->addElement('select', 'interface', get_string("class_view_interface", "local_zilink"), $directories);

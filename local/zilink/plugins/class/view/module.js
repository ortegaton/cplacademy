M.local_zilink_class_view_attendance_overview_chart = {
        ...
        init: function(Y, myDataValues, maxValue, sesskey) {
            ...
            var attendance_overview = new Y.Chart({    
                ...
                render:                "#zilink_class_view_attendance_overview_chart",
...
M.local_zilink_class_view_assessment_overview_chart = {
        ...
        init: function(Y, myDataValues, minValue, maxValue,grades,resultType,extlinks,sesskey) {
            ...
            assessment_overview.render("#zilink_class_view_assessment_overview_chart");
            
        }
},

M.local_zilink_class_view_reports = {
        ...
        viewreport: function() {
            ...
            window.open(this.domain+'/local/zilink/plugins/class/view/interfaces/default/pages/reports.php?action=view&cid='+this.courseid +'&rid='+ this.reportid +'&offset='+this.offset+'&sesskey='+this.sesskey,"_blank",'width=900');
        }
};
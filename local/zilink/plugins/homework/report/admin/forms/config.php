...
class zilink_homework_report_config_settings_form extends moodleform {
    ...
    public function definition() {
        ...
        $path = $CFG->dirroot.'/local/zilink/plugins/homework/report/interfaces';
        $directories = array();
        ...
        $select = $mform->addElement('select', 'interface', get_string("homework_report_interface", "local_zilink"), $directories);

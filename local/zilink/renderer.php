...
foreach ($directories as $directory) {
    if (file_exists($CFG->dirroot . '/local/zilink/plugins/' . $directory . '/renderer.php')) {
        include($CFG->dirroot . '/local/zilink/plugins/' . $directory . '/renderer.php');
    }
}

class local_zilink_renderer extends plugin_renderer_base {
...
$cancel = true;
    ...
    public function allschedules_link($id, $session) {
        ...
        $allparams = array('id' => $id, 'session' => $session->id,'sesskey' => sesskey());
        //$bookparams = array('session' => $session->id, 'sesskey' => sesskey());

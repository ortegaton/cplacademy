...
$PAGE->requires->js('/blocks/moodletxt/js/settings_accounts.js?v=1.0', true);
...
// Set structure
$tablecolumns = array("username", "description", "location", "messagessent", "editaccess", "allowoutbound",
...
$tableheaders = array(
    ...
    get_string('tableheaderlocation',        'block_moodletxt'),
    get_string('tableheadermessages',        'block_moodletxt'),
    get_string('tableheadereditaccess',      'block_moodletxt'),
...
foreach($accountList as $account) {
    ...
    $table->add_data(array(
        ...
        $account->getUrl() . ' - ' . $account->getLocation(),
        $sentMessageDAO->countMessagesSent($account->getId()),
        $output->render($accessImage),
        $output->render($outboundEnabled),

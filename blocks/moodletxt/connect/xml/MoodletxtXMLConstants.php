...
class MoodletxtXMLConstants {
   ...
   public static $MESSAGES_PER_BATCH = 50;
    ...
    public static $REQUEST_OPT_OUT_CHECK_BLOCK      = '<OptOutCheck returnBlockedOnly="true">';
    public static $_REQUEST_OPT_OUT_CHECK_BLOCK     = '</OptOutCheck>';

    public static $RESPONSE_OPT_OUT_CHECK_BLOCK     = 'OptOutCheckResponse';
    public static $RESPONSE_OPT_OUT_BLOCK           = 'OptOutResponse';
    public static $RESPONSE_OPT_OUT_BLOCK_FOR       = 'for';
    
    public static $RESPONSE_OPT_OUT_VAL_NEW             = 'NEW';
    public static $RESPONSE_OPT_OUT_VAL_WHITELISTED     = 'WHITELISTED';
    public static $RESPONSE_OPT_OUT_VAL_GREYLISTED      = 'GREYLISTED';
    public static $RESPONSE_OPT_OUT_VAL_BLACKLISTED     = 'BLACKLISTED';
    public static $RESPONSE_OPT_OUT_VAL_PENDING_WELCOME = 'PENDING_WELCOME';

...
class TxttoolsAccount {
    ...
    public static $UK_LOCATION = "UK";
    public static $US_LOCATION = "US";

    public static $UK_URL = 'www.bbconnecttxt.com';
    public static $US_URL = 'us.bbconnecttxt.com';
     ...
     * @param MoodletxtBiteSizedUser $defaultUser Default user for inbound messages
     * @param string $url
     ...
     * @since 2010082001
     */
    function __construct($username, $description, MoodletxtBiteSizedUser $defaultUser, $url, $location, $creditsUsed = 0, $creditsRemaining = 0,

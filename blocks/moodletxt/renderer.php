...
class moodletxt_icon implements renderable {
    ...
    /**
     * Path to the icon representing a message that has not been sent because of blacklisting
     * @var string
     */
    public static $ICON_STATUS_BLACKLISTED = 'pix/icons/status_blacklisted.png';

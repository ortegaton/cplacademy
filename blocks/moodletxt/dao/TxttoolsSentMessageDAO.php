...
class TxttoolsSentMessageDAO {    
    ...
    public function getSentMessageById($messageId, $includeSent = false, $includeStatuses = false) {
        ...
        $sql = 'SELECT o.id, u.id AS moodleuserid, u.username AS moodleuser, 
                ...
                acc.description, acc.defaultuser, acc.url, acc.location, o.messagetext, o.timesent, o.scheduledfor, o.type, o.fromevent
     ...
     * @return MoodletxtOutboundMessage[] array containing sent messages
     * @version 2015062901
     * @since 2011081101
     */

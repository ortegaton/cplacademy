    ...
    public static final function generateStatusIconForCode($statusCode) {
        ...
        switch($statusCode) {
            ...
            case MoodletxtOutboundSMSStatus::$STATUS_DELIVERED_TO_HANDSET:
                ...
                break;            
            case MoodletxtOutboundSMSStatus::$STATUS_BLACK_LISTED:
            case MoodletxtOutboundSMSStatus::$STATUS_BLACK_LISTED_INITIAL:
            case MoodletxtOutboundSMSStatus::$STATUS_PENDING_WELCOME_STATUS:
            case MoodletxtOutboundSMSStatus::$STATUS_QUEUED_MESSAGE_AND_WELCOME_MESSAGE_STATUS:
                $statusIcon = new moodletxt_icon(moodletxt_icon::$ICON_STATUS_BLACKLISTED,
                        get_string('altstatusblacklisted', 'block_moodletxt'),
                        array('title' => get_string('labelstatusblacklisted', 'block_moodletxt')));
                break;
            default:

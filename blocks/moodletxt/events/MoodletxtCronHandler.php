...
require_once($CFG->dirroot . '/blocks/moodletxt/service/BlacklistService.php');
...
class MoodletxtCronHandler {
    ...
    public function doCron() {
        ...
        //MOODTXT-10: decided to skip blacklist checks for now
        //$this->blacklistService->pollForBlacklistedRecipients();

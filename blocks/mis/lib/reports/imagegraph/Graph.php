 ...
 */
require_once dirname(__FILE__).'/Image/Graph/Element.php';

/**
 * Include file Image/Graph/Constants.php
 */
require_once dirname(__FILE__).'/Image/Graph/Constants.php';
...
class Image_Graph extends Image_Graph_Element
{
    ...
    function &factory($class, $params = null)
    {
        ...
        if ($class!='Image_Graph'){
            include_once dirname(__FILE__).'/'.str_replace('_', '/', $class) . '.php';
        }

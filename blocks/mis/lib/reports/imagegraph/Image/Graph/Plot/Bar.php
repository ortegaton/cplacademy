            ...
            while ($point = $dataset->_next()) {                
                ...
                if ((($minY = min($p0['Y'], $p1['Y'])) < $maxYaxis) &&
                    ...
                    */
                    ...
                    // GT MOD 2007/11/16 - Modification by Guy Thomas - fill style and line style should be retrieved by dataset id NOT point id                    
                    if (count($this->_dataset)>1){
                        if (isset($this->_dataset[$key]->_name)){
                            $ID = $this->_dataset[$key]->_name;
                        } else {
                            $ID = $key;
                        }
                    }
